        ...
        <div className="relative overflow-hidden rounded-2xl bg-[#051A24] mb-5" style={{ aspectRatio: '16/9' }}>
          ...
          <div className="absolute inset-0 bg-[#051A24]/0 group-hover:bg-[#051A24]/40 transition-all duration-300 flex items-center justify-center">
            <motion.div
              ...
              className="opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center gap-2 bg-white text-[#051A24] rounded-full px-5 py-2.5 text-sm font-medium"
            >
              Read case study
        ...
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <span className="font-mono text-[10px] uppercase tracking-widest text-[#8A8780]">
                {project.year}
              </span>
    ...
    <main>
      ...
      <section className="pt-40 pb-16 px-6 md:px-10 border-b border-[#D8D4CB]">
        <div className="max-w-[1320px] mx-auto" ref={heroRef}>
          ...
          >
            Three case studies across fintech, industrial software, and portfolio management. Each one is a full narrative — problem, process, result.
          </motion.p>
        </div>
      </section>
